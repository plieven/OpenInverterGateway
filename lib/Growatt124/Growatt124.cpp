...
void init_growatt124(sProtocolDefinition_t& Protocol, Growatt& inverter) {
  ...
  Protocol.InputRegisters[P124_BATTERY_TEMPERATURE] =
      sGrowattModbusReg_t{1040,
                          ...
                          (uint16_t) (1 / TEMPERATURE_WORKAROUND_MULTIPLIER),
                          TEMPERATURE,
                          true,
                          true};
